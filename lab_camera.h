    ...
    class Camera
    {
     public:
        ...
        void TranslateForward(float distance)
        {
            ...
            glm::vec3 foobar = forward;
            foobar.y = 0;
            position += foobar * distance;
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 rot_mat = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) ;
            glm::vec4 new_right = glm::normalize(rot_mat * glm::vec4(right, 0));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 new_up = glm::normalize(rot_mat * glm::vec4(up, 0));
            up = glm::vec3(new_up);
